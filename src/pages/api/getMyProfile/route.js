...
export default async function handler(req, res) {
  if (req.method === "GET") {
    try {
      ...
      const myRequestsPromises = userData.myRequests.map(async (requestRef) => {
        ...
        // delete data.uploadedImageRef;

        return data;
      });
      const myRequests = await Promise.all(myRequestsPromises);
